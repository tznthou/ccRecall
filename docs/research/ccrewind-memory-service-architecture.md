...
不需要 Memory Service。阻擋 auto-compact + 通知使用者先存檔，5 分鐘 fallback 避免 session 崩潰。
...
| 文件 | 位置 |
|------|------|
| 記憶系統設計（元認知核心） | [`docs/research/ai-long-term-memory-design.md`](./ai-long-term-memory-design.md) |
| 十歲版運作原理 | [`docs/research/ccrecall-for-kids.md`](./ccrecall-for-kids.md) |
| ccRewind 原始碼 | [github.com/tznthou/ccRewind](https://github.com/tznthou/ccRewind) |
