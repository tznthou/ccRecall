  ...
  server.registerTool(
    'recall_query',
    {
      ...
      description: [
        ...
        '',
        'ccRecall is a user-scoped memory store. It complements the curated',
        'MEMORY.md index that loads at session start: MEMORY.md carries a',
        'small hand-picked set; ccRecall carries the rest — decisions,',
        'discoveries, patterns, and corrections from past sessions.',
        '',
        'SCOPE — read this before interpreting an empty result:',
        'Results are restricted to the CURRENT project. This is a hard filter,',
        'not a ranking preference: memories from your other projects are not in',
        'the result set at all. "No memories found" therefore means "nothing in',
        'this project", NOT "this knowledge does not exist". A principle learned',
        'in another project will never appear here, however relevant it is.',
        '',
        'USE THIS WHEN:',
        ...
        '',
        'ALSO USE THIS WHEN NOBODY ASKED — the cases above all require someone',
        'to bring up the past, which is exactly when a forgotten constraint',
        'does NOT get mentioned:',
        '- Before committing to an architectural pattern, a new dependency, or',
        '  a security boundary — check whether a past decision constrains it',
